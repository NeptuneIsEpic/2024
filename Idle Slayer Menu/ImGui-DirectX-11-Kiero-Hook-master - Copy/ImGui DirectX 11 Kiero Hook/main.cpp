...
HRESULT __stdcall hkPresent(IDXGISwapChain* pSwapChain, UINT SyncInterval, UINT Flags)
{
	...
	if (globals::show)
	{
		...
		ImGui::Begin(("Idle Slayer - neptune4953"), NULL, ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoCollapse);
		{ImGui::SameLine();
		...
		if (globals::tab == 0)
		{
			...
			{
				*(double*)mem::FindAddress(moduleBase + 0x01F1BFF0, { 0xB8, 0x0, 0x10, 0x70, 0x50, 0x28, 0x20 }) = globals::coins;
			}
		}
		if (globals::tab == 1)
		{
